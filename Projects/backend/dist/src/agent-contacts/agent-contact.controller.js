...
const create_agent_contact_dto_1 = require("./dto/create-agent-contact.dto");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
let AgentContactController = class AgentContactController {
    agentContactService;
    constructor(agentContactService) {
        this.agentContactService = agentContactService;
    }
    async createContact(dto, req) {
        const userId = req.user.id;
        return this.agentContactService.createContact(dto, userId);
    }
};
exports.AgentContactController = AgentContactController;
__decorate([
